                    ...
                    <div class="card-body">
                        <div class="col-md-12">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <a href="{{ route('user.create') }}" class="btn btn-primary" style="float: right;margin-bottom: 17px;">Create Author</a>
                                </div>
                            </div>
                        </div>
                                                    ...
                                                    <td class="text-right">
                                                        <div class="btn-group">
                                                            ...
                                                            <ul class="dropdown-menu pull-right" role="menu">
                                                                <li><a class="dropdown-item" href="{{ route('user.edit',$user->id) }}"><i class="fa fa-edit"></i> Edit</a></li>
                                                                <li><a class="dropdown-item" href="" onclick="updateStatus({{ $user->id }})"><i class="fa fa-fw fa-search-plus"></i> Status</a></li>
                                                                <li><div role="separator" class="dropdown-divider"></div></li>
                                                                <li>
                                                                    <a type="button"  onclick="deleteconfirm('{{ $user->id }}')" style="margin-left: 20px;color: rebeccapurple;"><i class="fa fa-trash"></i>Delete</a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </td>
