            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="post" class="form-horizontal" action="{{ route('user.update',$user) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="box-body" style="width: 60%;margin: 0 auto;">
                                <div class="form-group" style="margin-left: 5px;">
                                    ...
                                    <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" placeholder="Name" value="{{ $user->name }}"  style="width: 98%;">
                                    @error('name')
                                ...
                                <div class="form-group" style="margin-left: 5px;">
                                    <label for="email">Email<span
                                            style="color: red">*</span></label>
                                    <input id="email" type="text" class="form-control @error('email') is-invalid @enderror" name="email" placeholder="Email" value="{{ $user->email }}"  style="width: 98%;">
                                    @error('email')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="box-body" style="width: 60%;">
                                    <div class="form-group" style="margin-left: 5px;">
                                        ...
                                        <input type="radio" value="1" id="Admin" name="type" {{$user->type == 'Admin' ? 'checked' : ''}}>
                                        <label class="checkbox-inline" for="Admin">Admin</label>

                                        <input type="radio" value="2" id="Author" name="type"}} style="margin-left: 10px;" {{$user->type == 'Author' ? 'checked' : ''}}>
                                ...
                                <div class="form-group" style="margin-left: 5px;">
                                    ...
                                    <textarea type="text" rows="3" class="form-control  @error('details') is-invalid @enderror" name="details" id="details" style="width: 98%;" required>{{ $user->details }}</textarea>
                                    @error('details')
                                    <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                                ...
                                <div class="form-group" style="margin-left: 5px;">
                                    ...
                                    <img id="image" style="width:10%;margin-bottom: 8px;margin-left: -6px;margin-top: 8px;" src="{{ asset($user->image) }}"><br>
